...
describe('http.storefront.pages.checkout.request.after implementing http.storefront.pages.checkout.request.after', function () {

  var action;

  before(function () {
    action = require('../src/domains/storefront/http.storefront.pages.checkout.request.after');
  });
