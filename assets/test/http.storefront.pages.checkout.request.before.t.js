...
describe('http.storefront.pages.checkout.request.before implementing http.storefront.pages.checkout.request.before', function () {

  var action;

  before(function () {
    action = require('../src/domains/storefront/http.storefront.pages.checkout.request.before');
  });
